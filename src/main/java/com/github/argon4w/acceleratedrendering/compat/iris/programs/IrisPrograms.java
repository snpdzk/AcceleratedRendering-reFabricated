...
public class IrisPrograms {
    ...
    public static void onLoadComputeShaders(LoadComputeShaderEvent event) {
        event.loadComputeShader(
                ...
                AcceleratedRenderingModEntry.location("shaders/compat/transform/iris_block_vertex_transform_shader.compute"),
        ...
        event.loadComputeShader(
                ...
                AcceleratedRenderingModEntry.location("shaders/compat/culling/iris_block_quad_culling_shader.compute"),
                BarrierFlags.SHADER_STORAGE,
        ...
        event.loadComputeShader(
                ...
                AcceleratedRenderingModEntry.location("shaders/compat/culling/iris_block_triangle_culling_shader.compute"),
                BarrierFlags.SHADER_STORAGE,
                BarrierFlags.ATOMIC_COUNTER
        );
        ...
        event.loadComputeShader(
                ...
                AcceleratedRenderingModEntry.location("shaders/compat/processing/iris_block_quad_processing_shader.compute"),
                BarrierFlags.SHADER_STORAGE
        );

        event.loadComputeShader(
                IRIS_BLOCK_TRIANGLE_PROCESSING_KEY,
                AcceleratedRenderingModEntry.location("shaders/compat/processing/iris_block_triangle_processing_shader.compute"),
                BarrierFlags.SHADER_STORAGE
        );
